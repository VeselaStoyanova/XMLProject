function createXMLDocument() {
    ...
    history.appendChild(doc.createTextNode("Една от теориите за основаването на Барселона е, че градът е основан в средата на II век пр.н.е. от Картаген. \n\t\t\t                Бащата на Ханибал Барка – Хамилкар се смята за основателя на града, като фамилното име Барка е в основата на името на града. По-късно става част от Римската империя. След разделянето на империята през 395 г. сл. Хр. градът е част от Западната Римска империя. С нахлуването на различни варварски племена през V век сл. Хр. на територията на Иберийския полуостров, градът е владение на остготите и основаното от тях кралство. \n\t\t\t                В началото на VIII век маврите, съставляващи най-общо казано бербери и араби от Африка нахлуват на територията на Иберийския полуостров, но Барселона не е завзета. През първата половина на 9 век градът става център на графство Барселона и на Испанската марка."));
    ...
    enrollment_conditions.appendChild(doc.createTextNode("Записването е възможно по телефон, интернет или директно в офиса. Резервацията се счита за валидна след сключване на Договор и внасяне на депозит.\n" +
    ...
    payment_terms.appendChild(doc.createTextNode(" До 1 ден след резервацията е необходимо да бъде платено 20% от сумата. До 21 дни преди датата на отпътуване е необходимо да се плати 100% от сумата."));
